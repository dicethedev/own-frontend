...
import { Button, Card, CardContent, CardHeader, CardTitle } from "@/components/ui/BaseComponents";
    ...
    return (
        <Card className="bg-white/10 border-gray-800 rounded-lg">
            ...
            <CardContent className="p-4 flex flex-col items-center">
                <p className="text-gray-400">Access to LP features are invite only!</p>
                <Button className="mt-4 justify-center">
                    <a href="https://t.me/x0bhargav" target="_blank">
                    <div className="flex items-center gap-2">Request Invite<ArrowUpRight size={14} /></div>
                    </a>
                </Button>
            </CardContent>
        </Card>
