    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct IPoolLiquidityManager.LPPosition",
        components: [
          {
            name: "liquidityCommitment",
            type: "uint256",
            internalType: "uint256",
          },
          {
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct IPoolLiquidityManager.LPRequest",
        components: [
          {
            name: "requestType",
            type: "uint8",
    ...
    outputs: [
      {
        name: "",
        type: "address",
        internalType: "contract IPoolLiquidityManager",
      },
    ],
    stateMutability: "view",
  },
