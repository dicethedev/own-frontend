export const protocolRegistryABI = [
  ...
  {
    type: "event",
    name: "StrategyVerificationUpdated",
    inputs: [
      {
        name: "strategy",
        type: "address",
