export const assetOracleABI = [
  ...
  {
    type: "function",
    name: "updateDefaultSubscriptionId",
    inputs: [
      {
  ...
  {
    type: "function",
    name: "updateMarketOpenThreshold",
    inputs: [
      {
        name: "newThreshold",
        type: "uint256",
  ...
  {
    type: "event",
    name: "DefaultSubscriptionIdUpdated",
    inputs: [
      {
  ...
  {
    type: "event",
    name: "MarketOpenThresholdUpdated",
    inputs: [
      {
        name: "oldThreshold",
        type: "uint256",
